...
~~~ {.bash}
git clone https://github.com/bheisig/cli.git
~~~
...
-   You need at least PHP 7.2 (7.1 still works, but is deprecated, 7.3 is recommended, 7.4 should work)
...
6.  Create Git tag: `git tag -s -a -m "Release version $(composer config extra.version)" $(composer config extra.version)`
7.  Push changes: `git push --follow-tags`
...
[packagist]: https://packagist.org/packages/bheisig/cli
